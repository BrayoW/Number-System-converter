...
fromSelected.addEventListener("change", function () {
    fromNS = fromSelected.options[fromSelected.selctedIndex].text;
                ...
                case "Hexadecimal":
                    ...
                    if(/^[0-9a-fA-F]*$/.test(fromValue)) {
                        switch (toNS) {
                            ...
                            break;
                            case"Octal": to.value = parsenInt(fromValue, 16).toString(8);
                            break;
                            default: to.value = fromValue;
                        }
                    }else{
                    ...
                    case "Octal":
                        ...
                        if(/^[0-7]*$/.test(fromValue)) {
                            switch (toNS){
                                ...
                                break;
                                case "Decimal": to.value = parseInt(froValue, 8);
                                break;
